          ...
          <div className="p-8">
            ...
            {selectedProfile && (
              <>
                ...
                <div className="w-full flex items-center justify-center gap-3 border border-gray-100 bg-gray-50 text-gray-400 py-2.5 rounded-lg text-sm mb-1 cursor-not-allowed select-none">
                  <svg width="18" height="18" viewBox="0 0 48 48" className="opacity-30">
                ...
                <p className="text-xs text-center text-amber-600 bg-amber-50 border border-amber-100 rounded-lg px-3 py-2 mb-3">
                  Login com Google temporariamente indisponível. Use email e senha.
                </p>
