...
const FROM = '022 RUNNER <noreply@022runners.com.br>';
...
<div class="header"><img src="https://022runners.com.br/images/logo-022runners.png" alt="022 RUNNER"></div>
...
export async function sendConfirmationEmail(reg: any, event: any) {
  const html = baseHtml(`
    ...
    <a href="https://022runners.com.br/confirmacao/${reg.id}" class="btn">Ver Comprovante</a>
...
export async function sendReminderEmail(reg: any, event: any) {
  const html = baseHtml(`
    ...
    <a href="https://022runners.com.br/evento/${event.slug}" class="btn">Ver Detalhes</a>
  `);
...
export async function sendOrganizerNotification(event: any, reg: any) {
  const html = baseHtml(`
    ...
    <a href="https://022runners.com.br/organizador" class="btn">Ver no Painel</a>
  `);
...
export async function sendWelcomeEmail(user: { name: string; email: string }) {
  const html = baseHtml(`
    ...
    <a href="https://022runners.com.br/eventos" class="btn">Ver Eventos</a>
  `);
